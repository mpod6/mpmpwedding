...
<!-- ═══════════════════════════════════════════════════════════════════════
  SCAFFOLD — how to finish this page:
  1. Replace every ✎-marked italic line with your real answer (plain text).
  2. Delete any questions that don't apply; add your own with the same
     <details class="faq-item"> pattern.
  3. When you're happy: remove the `draft: true` line above so the page
     publishes, and uncomment the FAQ entry in
     plugins/wedding-nav/dist/components/index.js so it appears in the nav.
  Some answers are prefilled from facts already on the site — double-check
  them, they're marked with ✔.
═══════════════════════════════════════════════════════════════════════ -->
...
✔ Valet parking is free of charge, and there's a self-parking lot immediately next to the venue. Details on the [getting here](travel) page.
...
<details class="faq-item">
<summary>I have a food allergy or dietary restriction</summary>

✔ The [RSVP](rsvp) form has a spot for exactly this — tell us there and we'll make sure the kitchen knows.

</details>

<details class="faq-item">
<summary>Can I request a song?</summary>

✔ Absolutely — the [RSVP](rsvp) form asks for the song that will get you on the dance floor, and we'll do our best to work it into the evening.
